...
const CheckboxTable = ({
  ...
  return (
    <>
      {data.length > 0 ? (
        <>
          {Object.values(levelData).map((item, tableIndex) => {
            return (
              <>
                {item.length > 0 && (
                  <>
                    ...
                    <div className="overflow-hidden rounded border border-neutral-200">
                      <table className="table table-fixed w-full min-w-[400px]">
                        <tr className="table-header-group h-10 font-medium border-b border-neutral-200 bg-neutral-100 text-left">
                          {isCheckboxVisible && (
                            <td className="p-0 w-10 align-middle border-r border-neutral-200">
                              <Checkbox
                          ...
                          <th
                            id={`id-${item[0]?.conformance_level}`}
                            scope="col"
                          ...
                          <th
                            ...
                            className="table-cell p-1 w-[80px] align-middle border-r border-neutral-200"
                          >
                            <p className="font-medium text-sm pl-1">Element</p>
                          </th>
                          <th
