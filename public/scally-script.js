      ...
      if (
        ...
        (l = (function e(n, r = []) {
          if (y(n)) {
            ...
            if ((r.unshift(t), !n.id && n.parentNode))
    ...
    return (
      ...
      (e.HTMLCS_SectionBB_Sniffs_ImgBtn = {
        ...
        validateImgBtnTag: function (t) {
          for (let n of HTMLCS.util.getUniversalElements(
            t,
            'button,input[type="image"]'
          )) {
            var a = Array.from(n.getElementsByTagName("*"));
            let t = "",
              s = !1,
              r = !1,
              l = !1,
            ...
            let u = !1;
            "BUTTON" === n.nodeName &&
              (n.hasAttribute("title") && (r = !0), 0 < a.length) &&
              a.forEach((e) => {
                1 === e.nodeType &&
                  (("svg" !== e.nodeName.toLowerCase() &&
                    "img" !== e.nodeName.toLowerCase() &&
                    "i" !== e.nodeName.toLowerCase()) ||
                    ((t = e.nodeName.toLowerCase()), (d = e)),
              ...
              "input" === n.nodeName.toLowerCase() &&
                n.hasAttribute("type") &&
                "image" === n.getAttribute("type") &&
                ((s = !0),
                n.hasAttribute("alt") && (l = !0),
                n.hasAttribute("title") && (o = !0),
                (i = n)),
              "" !== t
                ? (n.hasAttribute("tabindex") &&
                  ...
                  ? HTMLCS.addMessage(
                      HTMLCS.WARNING,
                      n,
                      e.HTMLCS.getAttribute(n, "tabindex,aria-hidden", !0),
                      "BB10310"
                    )
                  : this.checkImgBtnAriaConditions(n, r, t, d, u)
                : s &&
                  ...
                  (i.hasAttribute("aria-hidden") &&
                    ...
                    : (l
                      ...
                      this.checkInputImgBtnAriaConditions(n, o, l, i)));
          }
        },
      ...
      (e.HTMLCS_SectionBB_Sniffs_ImgLinks = {
        ...
        validateImgATag: function (t) {
          HTMLCS.util.getUniversalElements(t, "a").forEach((t) => {
            var a = Array.from(t.getElementsByTagName("*"));
            let i = "";
            var n,
              s = t.hasAttribute("title");
            let r = null,
              l = !1;
            0 < a.length &&
              a.forEach((e) => {
              ...
              "" !== i &&
                ((a = "-1" === t.getAttribute("tabindex")),
                (n = "true" === t.getAttribute("aria-hidden")),
                a || n
                  ? HTMLCS.addMessage(
                      HTMLCS.WARNING,
                      t,
                  ...
                  : this.checkImgLinkAriaConditions(t, s, i, r, l));
          });
        },
      ...
      (e.HTMLCS_SectionBB_Sniffs_Landmark = {
        ...
        process: function (e, t) {
          var a = [],
            ...
            s = [],
            r = [],
            l = Array.from(t.getElementsByTagName("header")),
            a = Array.from(t.getElementsByTagName("footer")),
            i = Array.from(t.getElementsByTagName("main")),
            r = Array.from(t.getElementsByTagName("nav")),
            n = Array.from(t.getElementsByTagName("form")),
            s = Array.from(t.getElementsByTagName("aside"));
          ...
          this.headerBannerCheck(l),
            this.footerContentCheck(a),
            0 === i.length
              ? HTMLCS.addMessage(
                  HTMLCS.ERROR,
                  document.body,
        ...
        checkAsideBlankAria: function (t, a) {
          "" === t.getAttribute("aria-label").trim()
            ? HTMLCS.addMessage(
                HTMLCS.ERROR,
                t,
      ...
      (e.HTMLCS_SectionBB_Sniffs_Lists = {
        ...
        checkListTags: function (t) {
          ...
          if ("OL" !== t.nodeName && "UL" !== t.nodeName)
            for (let i of t.getElementsByTagName("*"))
              1 === i.nodeType &&
                i.hasAttribute("role") &&
                "LI" === i.nodeName &&
                (HTMLCS.addMessage(
        ...
        DefList: function (t) {
          let a = 0,
            ...
            r = 0,
            l = !1;
          for (let e of t.getElementsByTagName("*"))
            1 === e.nodeType &&
              ("DT" === e.nodeName &&
                (a++,
                0 === HTMLCS.util.getElementTextContent(e).trim().length &&
        ...
        process: function (t) {
          for (let n of HTMLCS.util.getUniversalElements(
            ...
            let t = !1,
              ...
              u = !1;
            if (
              "none" === HTMLCS.util.style(n)?.display ||
              "true" === n.getAttribute("aria-hidden") ||
              "presentation" === n.getAttribute("role") ||
              "none" === n.getAttribute("role") ||
              "-1" === n.getAttribute("tab-index")
            )
              HTMLCS.addMessage(
                HTMLCS.WARNING,
                n,
                e.HTMLCS.getAttribute(n, "role,aria-hidden,tabindex", !0),
                "BB10430"
              );
            else {
              var a = HTMLCS.util.getPreviousSiblingElement(n, "LABEL"),
                i = HTMLCS.util.getNextSiblingElement(n, "LABEL");
              if (null !== a || null !== i) {
                let e = a;
                null === a && (e = i),
                  (a = HTMLCS.util.style(e)?.display),
                  "true" !== e.getAttribute("aria-hidden") && "none" !== a
                    ? "LABEL" === e.parentNode.nodeName
                      ? (s = !0)
                      : (n.hasAttribute("id") || (r = !1),
                        e.hasAttribute("for") &&
                          ((l = !0),
                          (o = e.getAttribute("for") == n.getAttribute("id"))))
                    : (u = !0);
              }
              n.hasAttribute("title") && (t = !0),
                n.hasAttribute("aria-label") && (d = !0),
                n.hasAttribute("aria-labelledby")
                  ? HTMLCS.util.hasValidLabelId(n)
                    ? HTMLCS.addMessage(
                        HTMLCS.WARNING,
          ...
          for (let a of HTMLCS.util.getUniversalElements(
            ...
            let t = !1,
              ...
              d = !1,
              u = !1;
            var n = HTMLCS.util.getPreviousSiblingElement(a, "LABEL"),
              s = HTMLCS.util.getNextSiblingElement(a, "LABEL");
            if (null !== n || null !== s) {
              let e = n;
              null === n && (e = s),
                (n = HTMLCS.util.style(e)?.display),
                "true" !== e.getAttribute("aria-hidden") && "none" !== n
                  ? "LABEL" === e.parentNode.nodeName
                    ? (i = !0)
      ...
      (e.HTMLCS_SectionBB_Sniffs_SkipLinks = {
        ...
        process: function (e) {
          ...
          var i = ["skip", "content"];
          for (let s of (0 <
            HTMLCS.util.getUniversalElements(e, "h1, h2, h3, h4, h5, h6,main")
              .length && (t = !1),
          HTMLCS.util.getUniversalElements(e, "header"))) {
            var n = HTMLCS.util.getUniversalElements(e, "button,a");
            if (1 < n.length) {
              for (let e of n) {
                let t = HTMLCS.util.getTextContent(e).trim();
                i.some((e) => t.includes(e)) && (a = !0);
              }
              if (a) {
                let e = !1,
                  t = HTMLCS.util.getTextContent(s.firstElementChild).trim();
                i.some((e) => t.includes(e)) && (e = !0),
                  ("A" === s.firstElementChild.nodeName ||
                    "BUTTON" === s.firstElementChild.nodeName) &&
                  e
                    ? HTMLCS.addMessage(
                        HTMLCS.WARNING,
                        s,
                    ...
                    : (HTMLCS.addMessage(
                      ...
                      HTMLCS.addMessage(
                        HTMLCS.ERROR,
                        s,
                        "Skip Links is not the First element",
                        "BB10451"
                      ));
              } else
                t
      ...
      (e.HTMLCS_SectionBB_Sniffs_Svg = {
        ...
        checkSvgHasParent: function (t, a = null) {
          ...
          var o = t ? t.childNodes.length : 0,
            d = Array(t.getElementsByTagName("*"));
      ...
      (e.HTMLCS.util = {
        ...
        getUniversalElements: function (e, t) {
          ...
          for (let t of e) {
            ...
            "NOSCRIPT" !== t.nodeName &&
              "hidden" !== n.visibility &&
              "none" !== t.parentElement.style.display &&
              ((a[i] = t), i++);
          }
          return (a.length = i), a;
        },
