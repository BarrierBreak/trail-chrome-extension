...
const iframe = new DOMParser().parseFromString(
  "<iframe id='trail-iframe' title='trail-extension' style = 'width: 0px; height: 100vh; position: fixed; top: 0; right: 0; z-index: 9999'></iframe>",
  "text/html"
).body.firstElementChild;
