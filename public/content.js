...
const iframe = new DOMParser().parseFromString(
  "<iframe id='trail-iframe' title='trail-extension' style = 'width: 0px !important; height: 100vh; position: fixed; top: 0; right: 0; border-radius: 5px; z-index: 9999999999; box-shadow: -8px 0px 24px 0px rgba(0, 0, 0, 0.12);'></iframe>",
  'text/html'
).body.firstElementChild
