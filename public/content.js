    ...
    return (
      ...
      (e.HTMLCS_SectionBB_Sniffs_Landmark = {
        ...
        process: function (e, t) {
          ...
          for (let e of HTMLCS.util.getUniversalElements(t, "header"))
            a.push(e);
...
window.addEventListener("scally_send", async (event) => {
  ...
  //   })
  // );
  // console.log("scally_receive event sent:", event);
  const newEvent = new CustomEvent("scally_receive", {
    detail: {
      name: "scally",
      data: auditResult,
    },
  });
  // console.log("scally_receive event created", newEvent);
