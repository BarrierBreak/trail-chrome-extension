...
function showHeadings() {
  ...
  headings.forEach((heading) => {
    ...
    headingLabel.style.padding = '2px'
    headingLabel.style.fontSize = 'small'
    headingLabel.style.fontWeight = 'bold'
    headingLabel.style.borderRadius = '4px'
    headingLabel.style.zIndex = '100000'
    headingLabel.style.speak = 'literal-punctuation'
...
function showLandMarks() {
  ...
  landmarks.forEach((landmark) => {
    ...
    landmarkLabel.style.padding = '2px'
    landmarkLabel.style.fontSize = 'small'
  ...
  sections.forEach((section) => {
    ...
    sectionLabel.style.padding = '2px'
    sectionLabel.style.fontSize = 'small'
