  ...
  !(function (e, t) {
    ...
    return (
      ...
      (e.HTMLCS_SectionBB_Sniffs_ImgBtn = {
        ...
        validateImgBtnTag: function (t) {
          for (let s of HTMLCS.util.getUniversalElements(
            ...
            let g = !1
            'BUTTON' === s.nodeName &&
              'switch' !== s.getAttribute('role') &&
              'tab' !== s.getAttribute('role') &&
              'radio' !== s.getAttribute('role') &&
              'checkbox' !== s.getAttribute('role') &&
      ...
      (e.HTMLCS_SectionBB_Sniffs_ImgLinks = {
        ...
        checkImgLinkAriaConditions: function (t, a, i, n, s) {
          if (t.hasAttribute('aria-label'))
            ...
            HTMLCS.addMessage(HTMLCS.WARNING, t, a || s, 'BB10631')
          else
            switch (i) {
              case 'i':
                e.HTMLCS_SectionBB_Sniffs_ImgIcon.validateImgIcon(n, t)
      ...
      (e.HTMLCS_SectionBB_Sniffs_Landmark = {
          ...
          0 < t.length &&
            t.forEach((a) => {
              ...
              for (
                ...
                1 === a.childNodes[s].nodeType &&
                  n.includes(a.childNodes[s].nodeName.toLowerCase()) &&
                  (i = !0)
              var r = HTMLCS.util.style(a)
              'none' === r?.display ||
              'hidden' === r.visibility ||
                  ...
                  ? a.hasAttribute('aria-label') &&
                    ...
                    ? a.hasAttribute('aria-labelledby') &&
                      (HTMLCS.util.hasValidLabelId(a)
                        ? this.checkFormBlankAria(a, t, 'aria-labelledby', i)
                        : a.hasAttribute('aria-label')
                        ? this.checkFormBlankAria(a, t, 'aria-label', i)
                        : HTMLCS.addMessage(
                            HTMLCS.ERROR,
                            a,
                            'Missing ID',
        ...
        checkFormBlankAria: function (t, a, i, n) {
          let s = !0
          t.hasAttribute('aria-label') &&
            '' === t.getAttribute('aria-label').trim() &&
            (HTMLCS.addMessage(
      ...
      (e.HTMLCS_SectionBB_Sniffs_Native = {
        ...
        process: function (t) {
          ...
          var i = HTMLCS.util.getUniversalElements(t, 'input[type="radio"]')
          for (let t of i) {
            let a = !1,
              n = !1,
              s = t.parentElement
            for (; 'body' !== s.nodeName.toLowerCase(); )
              if ('legend' === s.nodeName.toLowerCase()) {
                let e = s.parentElement
                for (; 'body' !== e.nodeName.toLowerCase(); )
            ...
            let r = !1
            for (s = t.parentElement; 'body' !== s.nodeName.toLowerCase(); ) {
              if ('group' === s.getAttribute('role')) {
                r = !0
                break
              }
              s = s.parentElement
              ...
              ? r &&
                (s.hasAttribute('aria-label')
                  ? HTMLCS.addMessage(
                      HTMLCS.WARNING,
                      s,
                      e.HTMLCS.getAttribute(s, 'aria-label'),
                      'BB10577'
                    )
                  ...
                  ? (HTMLCS.addMessage(
                      HTMLCS.WARNING,
                      s,
                      e.HTMLCS.getAttribute(s, 'aria-labelledby'),
                      'BB10577'
                    ),
                    HTMLCS.util.hasValidLabelId(s) ||
                      HTMLCS.addMessage(
                        HTMLCS.ERROR,
                        s,
                        'Missing ID',
          ...
          var n = HTMLCS.util.getUniversalElements(t, 'input[type="checkbox"]')
          for (let t of n) {
            let a = !1,
              i = !1,
              l = t.parentElement
            for (; 'body' !== l.nodeName.toLowerCase(); )
              if ('legend' === l.nodeName.toLowerCase()) {
            ...
            let o = !1
            for (l = t.parentElement; 'body' !== l.nodeName.toLowerCase(); ) {
              if ('group' === l.getAttribute('role')) {
                o = !0
                break
              }
              l = l.parentElement
              ...
              ? o &&
                (l.hasAttribute('aria-label')
                  ? HTMLCS.addMessage(
                      HTMLCS.WARNING,
                      l,
                      e.HTMLCS.getAttribute(l, 'aria-label'),
                      'BB10580'
                    )
                  ...
                  ? (HTMLCS.addMessage(
                      HTMLCS.WARNING,
                      l,
                      e.HTMLCS.getAttribute(l, 'aria-labelledby'),
                      'BB10580'
                    ),
                    HTMLCS.util.hasValidLabelId(l) ||
                      HTMLCS.addMessage(
                        HTMLCS.ERROR,
                        l,
                        'Missing ID',
            ...
            let d = !1,
              ...
              M = !1,
              C = !1
            var s = HTMLCS.util.getPreviousSiblingElement(t, 'LABEL'),
              r = HTMLCS.util.getNextSiblingElement(t, 'LABEL')
            if (null !== s || null !== r) {
              let e = s
              null === s && (e = r),
                (s = HTMLCS.util.style(e)?.display),
                'true' !== e.getAttribute('aria-hidden') && 'none' !== s
                  ? 'LABEL' === e.parentNode.nodeName
                    ? (u = !0)
                    : (t.hasAttribute('id') || (g = !1),
                      e.hasAttribute('for') &&
                        ((c = !0),
                        (T = e.getAttribute('for') == t.getAttribute('id'))))
                  : (C = !0)
            }
            t.hasAttribute('title') && (d = !0),
              t.hasAttribute('aria-label') && (M = !0),
              t.hasAttribute('aria-labelledby')
                ? HTMLCS.util.hasValidLabelId(t)
                  ? HTMLCS.addMessage(
                      HTMLCS.WARNING,
      ...
      (e.HTMLCS_SectionBB_Sniffs_Universal = {
        ...
        process: (t) => {
          var a = [],
            ...
            r = [],
            l = []
          for (let h of HTMLCS.util.getUniversalElements(t, 'body *')) {
            let t = ''
            if (
              (h.hasAttribute('role') && (t = h.getAttribute('role')),
              'meter' === h.nodeName.toLowerCase() && i.push(h),
              'BLINK' === h.nodeName &&
                HTMLCS.addMessage(
                  HTMLCS.WARNING,
                  h,
              ...
              'AUDIO' === h.nodeName || 'VIDEO' === h.nodeName)
            ) {
              let t = null
              for (let e of h.childNodes) 'SOURCE' === e.nodeName && (t = e)
              h.hasAttribute('autoplay') &&
                t.hasAttribute('src') &&
                ...
                ((d = h).duration <= 3
                  ? HTMLCS.addMessage(
                      HTMLCS.PASS,
                      h,
                      'Media Duration: ' + d.duration + ' secs',
                      'BB10455'
                    )
                  : h.hasAttribute('autoplay') &&
                    (h.hasAttribute('mute') || 0 == d.volume)
                  ? HTMLCS.addMessage(
                      HTMLCS.PASS,
                      h,
                      e.HTMLCS.getAttribute(h, 'mute,autoplay', !0),
                      'BB10456'
                    )
                  : (HTMLCS.addMessage(
                      HTMLCS.WARNING,
            ...
            if (3 === h.nodeType) {
              var o,
                d = HTMLCS.util.getPreviousSiblingElement(h, 'A'),
                u = HTMLCS.util.getNextSiblingElement(h, 'A')
              if (null !== d || null !== u) {
                let e = d
                null === d && (e = u)
                var u = HTMLCS.util.style(e),
                  g = HTMLCS.util.style(h),
                  c = u.color,
                  g = g.color,
                  c = HTMLCS.util.contrastRatio(c, g),
                  g = 0.01 * Math.trunc(c / 0.01)
                3 <= g
                  ? HTMLCS.addMessage(HTMLCS.PASS, h, g + ':1', 'BB10621')
                  : 'underline' === u.textDecoration || 'bold' === u.fontWeight
                  ? HTMLCS.addMessage(HTMLCS.PASS, h, 'Perfect Link', 'BB10621')
                  : HTMLCS.addMessage(
                      HTMLCS.ERROR,
                      h,
                      'Check Link Styling',
            ...
            ;('LI' !== h.nodeName && 'listitem' !== t) ||
              ('UL' !== h.parentElement.nodeName &&
                'OL' !== h.parentElement.nodeName &&
                'list' !== h.getAttribute('role') &&
                1 === h.parentElement.nodeType &&
                HTMLCS.addMessage(
                  HTMLCS.ERROR,
                  h,
                  'No Parent UL OL',
              ...
              ('DT' !== h.nodeName && 'DD' !== h.nodeName) ||
                ('DL' !== h.parentElement.nodeName &&
                  'list' !== h.getAttribute('role') &&
                  1 === h.parentElement.nodeType &&
                  HTMLCS.addMessage(HTMLCS.ERROR, h, 'No Parent DL', 'BB10371'))
            let S = null,
              H = !1,
              L =
                ((S = (c = HTMLCS.util.style(h)).backgroundColor),
                h.parentElement),
              b = !1
            for (
              'none' !== c.backgroundImage && (b = !0);
              ('transparent' === S || 'rgba(0, 0, 0, 0)' === S) &&
              L &&
              L.ownerDocument;

            ) {
              var T = HTMLCS.util.style(L)
              'none' !== T.backgroundImage && (b = !0),
                (S = T.backgroundColor),
                (L = L.parentElement)
            }
            ;(g = c.color), (u = parseFloat(c?.fontSize))
            let m = HTMLCS.util.colourStrToRGB(S).alpha
            ;(!b || 0 < m) &&
              ((S = 'rgba(0, 0, 0, 0)' === S ? 'rgba(255,255,255,1)' : S),
              (m = HTMLCS.util.colourStrToRGB(S).alpha))
            for (
              var M = HTMLCS.util.contrastRatio(S, g),
                C =
                  'fontsize--' +
                  u +
                  '==fontweight--' +
                  ...
                  S +
                  '==ratio--' +
                  0.01 * Math.trunc(M / 0.01) +
                  ':1',
                _ = 0;
              _ < h.childNodes.length;
              _++
            )
              3 === h.childNodes[_].nodeType &&
                h.childNodes[_].nodeValue &&
                '' !== h.childNodes[_].nodeValue.trim() &&
                (H = !0)
            let p = !1
            if (
              'hidden' !== c.visibility &&
              'none' !== c.display &&
              !HTMLCS.util.isDisabled(h)
            ) {
              let e = h.parentElement
              for (HTMLCS.util.style(e); 'BODY' !== e.nodeName; ) {
                if (
                  'hidden' === (o = HTMLCS.util.style(e)).visibility ||
                  'none' === o.display ||
            ...
            let f = !1
            if ('title' === h.nodeName.toLowerCase()) {
              let e = h.parentElement
              for (; 'body' !== e.nodeName.toLowerCase(); ) {
            ...
            switch (
              ('true' === h.getAttribute('aria-hidden') ||
                'hidden' === c.visibility ||
                'none' === c.display ||
                'true' === h.getAttribute('aria-disabled') ||
                HTMLCS.util.isDisabled(h) ||
                p ||
                f ||
                !H ||
                ...
                b
                  ...
                  : u < 24 &&
                    ...
                    700 > parseInt(c.fontWeight, 10)
                  ? M < 4.5
                    ? HTMLCS.addMessage(HTMLCS.ERROR, h, C, 'BB10571')
                    : HTMLCS.addMessage(HTMLCS.PASS, h, C, 'BB10572')
                  : ((19 <= u &&
                      u <= 23 &&
                      ('bold' === c.fontWeight ||
                        700 <= parseInt(c.fontWeight, 10))) ||
                      24 <= u) &&
                    (3 <= M
                      ? HTMLCS.addMessage(HTMLCS.PASS, h, C, 'BB10574')
                      : HTMLCS.addMessage(HTMLCS.ERROR, h, C, 'BB10573'))),
              t)
            ) {
              case 'textbox':
                e.HTMLCS_SectionBB_Sniffs_Universal.checkTextboxRole(h)
                break
              case 'search':
                a.push(h)
                break
              case 'list':
                e.HTMLCS_SectionBB_Sniffs_Lists.RoleTypeList(h)
                break
              case 'switch':
                e.HTMLCS_SectionBB_Sniffs_Universal.checkSwitchState(h)
                break
              case 'radio':
                e.HTMLCS_SectionBB_Sniffs_Universal.checkRadioState(h)
                break
              case 'directory':
                e.HTMLCS_SectionBB_Sniffs_Universal.checkDeperacted(h)
                break
              case 'meter':
                i.push(h)
                break
              ...
              case 'dialog':
              case 'alertdialog':
                e.HTMLCS_SectionBB_Sniffs_Dialog.checkDialog(h)
                break
              default:
                '' != t &&
                  e.HTMLCS_SectionBB_Sniffs_Universal.roleValidation(h, t)
            }
          }
          e.HTMLCS_SectionBB_Sniffs_Universal.checkSearchTags(a),
            ...
            e.HTMLCS_SectionBB_Sniffs_Universal.checkTabTags(s),
            e.HTMLCS_SectionBB_Sniffs_Universal.checkTabPanelTags(r),
            e.HTMLCS_SectionBB_Sniffs_Universal.checkTabListTags(l)
        },
        checkTabListTags: function (t) {
          t.forEach((a) => {
            1 < t
              ? a.hasAttribute('aria-labelledby')
                ? HTMLCS.util.hasValidLabelId(a)
        ...
        checkTabTags: function (t) {
          1 == t.length &&
            HTMLCS.addMessage(HTMLCS.WARNING, t[0], 'Check Tab', 'BB10582'),
            t.forEach((t) => {
              let a = null,
                i = t.parentElement
              for (; 'BODY' !== i.nodeName; ) {
                if ('tablist' === i.getAttribute('role')) {
                  a = !0
                  break
                }
                i = i.parentElement
              ...
              a ||
                ...
                t.hasAttribute('aria-selected')
                  ? HTMLCS.addMessage(
                      HTMLCS.WARNING,
                      t,
                      e.HTMLCS.getAttribute(t, 'aria-selected'),
                      'BB10585'
                    )
                  : HTMLCS.addMessage(
                      HTMLCS.ERROR,
                      t,
                      'Aria Selected not present',
                      'BB10584'
                    ),
                t.hasAttribute('aria-control') ||
                  HTMLCS.addMessage(
                    HTMLCS.NOTICE,
                    t,
                    'Aria Control Missing',
                    'BB10586'
                  )
              var n = HTMLCS.util.getUniversalElements(i, '[tabpanel]')
              if (0 < n.length)
                for (let a of n)
                  t.getAttribute('aria-control') === a.getAttribute('id')
                    ? HTMLCS.addMessage(
                        HTMLCS.PASS,
                        t,
                        e.HTMLCS.getAttribute(t, 'aria-control'),
                        'BB10589'
                      )
                    : HTMLCS.addMessage(
                        HTMLCS.ERROR,
              ...
              '0' == t.getAttribute('tabindex')
                ...
                : HTMLCS.addMessage(HTMLCS.ERROR, t, 'No Tab Index', 'BB10600')
            })
        },
              ...
              if (e) {
                ...
                if (l) {
                  ...
                  for (
                    0.75 * parseFloat(l.fontSize) >=
                      (C =
                        ...
                        600 <= parseInt(l.fontWeight, 10)
                          ? 14
                          : C) && (_ = a);
                    ('transparent' === T || 'rgba(0, 0, 0, 0)' === T) &&
                    M &&
                    M.ownerDocument;

                  ) {
                    var d = HTMLCS.util.style(M)
                    if (
                      ((T = d.backgroundColor),
                    ...
                    var u = HTMLCS.util.style(M, ':before')
                  ...
                  var g = HTMLCS.util.colourStrToRGB(T).alpha,
                  ...
                  r
                    ...
                    : 'transparent' !== T &&
                      'rgba(0, 0, 0, 0)' !== T &&
                      (g = HTMLCS.util.contrastRatio(T, o)) < _ &&
                      ((c = this.recommendColour(T, o, _)),
                      i.push({
                        element: s,
                        colour: l.color,
                        bgColour: T,
          ...
          if (d < a) {
            ...
            for (; d < a; ) {
              if ('#fff' === r || '#000' === r) {
                if (!0 === C) {
                  if ('fore' === l) {
                    ...
                    let e = 1
                    for (; M === u; )
                      (M = this.multiplyColour(M, Math.pow(1 / o, e))), e++
                  } else {
                    var g = T
                    let e = 1
                    for (; T === g; )
              ...
              _++,
                ...
                (r = this.multiplyColour(r, Math.pow(o, _))),
                'fore' === l ? (T = r) : (M = r),
                (d = HTMLCS.util.contrastRatio(T, M))
            }
            s = {fore: {from: i, to: T}, back: {from: n, to: M}}
          }
          return s
        },
            ...
            if (
              (void 0 === T
                ...
                ? (d.hasAttribute('multiple') ||
                  ...
                  (M = !0)
                : '@' === T.charAt(0) &&
                  ((T = T.substr(1, T.length)), !0 === d.hasAttribute(T)) &&
                  (M = !0),
              !1 === (M = !1 === M ? HTMLCS.util.hasValidAriaLabel(d) : M))
            ) {
              let t = u + ' ' + e.HTMLCS.getTranslation('4_1_2_element'),
                n =
                  ('input_' === u.substring(0, 6) &&
            ...
            for (let T = 0; T < n.length; T++) {
              ...
              for (let n = 0; n < s.childNodes.length; n++) {
                ...
                if (1 === r.nodeType) {
                  ...
                  if (o)
                    for (var u = T + 1; u < T + o; u++) {
                      t[u] || (t[u] = [])
                      for (var g = M; g < M + d; g++) t[u][g] = !0
                    }
                  if (l === e) {
                    if ('TH' === l) {
                      for (
                        var c = r.getAttribute('id') || '', u = T;
                        u < T + o;
                        u++
                      )
                        (a.rows[u] = a.rows[u] || {first: M, ids: []}),
                          a.rows[u].ids.push(c)
                      for (u = M; u < M + d; u++)
                        (a.cols[u] = a.cols[u] || {first: T, ids: []}),
                          a.cols[u].ids.push(c)
                    } else if ('TD' === l) {
                      let e = []
                      for (u = T; u < T + o; u++)
...
console.log('scally.js injected')
let htmlcsLoaded = false

chrome.runtime.onMessage.addListener(async (request, sender, sendResponse) => {
  if (request.type === 'RUN_AUDIT') {
    for (const option of request.options.runners) {
    ...
    const auditData = await window.__a11y.run(request.options)
